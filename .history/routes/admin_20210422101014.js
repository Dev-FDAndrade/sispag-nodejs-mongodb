...
//Funções
const removeEspacoDuplo = require('../funcoes/custom');
...
router.post('/addCatPagamento', (req, res) => {
    ...
    if (errors.length > 0) {
        ...
        //Dados do Formulário
        const data = {
            nome: removeEspacoDuplo2(req.body.nome)
        }
        //Verifica se categoria já existe
        modelCatPagamento.findOne({ nome: removeEspacoDuplo2(req.body.nome) }, function (err, novaCategoria) {
